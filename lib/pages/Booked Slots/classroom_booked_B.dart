...
class ClassroomBookedB extends StatefulWidget {
  const ClassroomBookedB({Key? key}) : super(key: key);

  @override
  _ClassroomBookedBState createState() => _ClassroomBookedBState();
}

class _ClassroomBookedBState extends State<ClassroomBookedB> {
  var _delGroup;
