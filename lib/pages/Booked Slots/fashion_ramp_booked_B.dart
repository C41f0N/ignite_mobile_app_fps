...
class FashionRampBookedB extends StatefulWidget {
  const FashionRampBookedB({Key? key}) : super(key: key);

  @override
  _FashionRampBookedBState createState() => _FashionRampBookedBState();
}

class _FashionRampBookedBState extends State<FashionRampBookedB> {
  var _delGroup;
