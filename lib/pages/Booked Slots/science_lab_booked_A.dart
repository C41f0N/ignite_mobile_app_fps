...
class ScienceLabBookedA extends StatefulWidget {
  const ScienceLabBookedA({Key? key}) : super(key: key);

  @override
  _ScienceLabBookedAState createState() => _ScienceLabBookedAState();
}

class _ScienceLabBookedAState extends State<ScienceLabBookedA> {
  var _delGroup;
