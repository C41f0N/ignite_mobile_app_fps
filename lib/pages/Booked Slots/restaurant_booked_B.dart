...
class RestaurantBookedB extends StatefulWidget {
  const RestaurantBookedB({Key? key}) : super(key: key);

  @override
  _RestaurantBookedBState createState() => _RestaurantBookedBState();
}

class _RestaurantBookedBState extends State<RestaurantBookedB> {
  var _delGroup;
