...
class FashionRampBookedA extends StatefulWidget {
  const FashionRampBookedA({Key? key}) : super(key: key);

  @override
  _FashionRampBookedAState createState() => _FashionRampBookedAState();
}

class _FashionRampBookedAState extends State<FashionRampBookedA> {
  var _delGroup;
