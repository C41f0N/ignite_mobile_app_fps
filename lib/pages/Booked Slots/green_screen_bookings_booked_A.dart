...
class GreenScreenBookingsBookedA extends StatefulWidget {
  const GreenScreenBookingsBookedA({Key? key}) : super(key: key);

  @override
  _GreenScreenBookingsBookedAState createState() => _GreenScreenBookingsBookedAState();
}

class _GreenScreenBookingsBookedAState extends State<GreenScreenBookingsBookedA> {
  var _delGroup;
