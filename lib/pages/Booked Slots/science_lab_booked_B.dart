...
class ScienceLabBookedB extends StatefulWidget {
  const ScienceLabBookedB({Key? key}) : super(key: key);

  @override
  _ScienceLabBookedBState createState() => _ScienceLabBookedBState();
}

class _ScienceLabBookedBState extends State<ScienceLabBookedB> {
  var _delGroup;
