...
class NewsRoomAndComputerLabBookedB extends StatefulWidget {
  const NewsRoomAndComputerLabBookedB({Key? key}) : super(key: key);

  @override
  _NewsRoomAndComputerLabBookedBState createState() => _NewsRoomAndComputerLabBookedBState();
}

class _NewsRoomAndComputerLabBookedBState extends State<NewsRoomAndComputerLabBookedB> {
  var _delGroup;
