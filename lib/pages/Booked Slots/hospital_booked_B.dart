...
class HospitalBookedB extends StatefulWidget {
  const HospitalBookedB({Key? key}) : super(key: key);

  @override
  _HospitalBookedBState createState() => _HospitalBookedBState();
}

class _HospitalBookedBState extends State<HospitalBookedB> {
  var _delGroup;
