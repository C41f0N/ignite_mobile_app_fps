...
class RestaurantBookedA extends StatefulWidget {
  const RestaurantBookedA({Key? key}) : super(key: key);

  @override
  _RestaurantBookedAState createState() => _RestaurantBookedAState();
}

class _RestaurantBookedAState extends State<RestaurantBookedA> {
  var _delGroup;
