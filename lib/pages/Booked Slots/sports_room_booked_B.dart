...
class SportsRoomBookedB extends StatefulWidget {
  const SportsRoomBookedB({Key? key}) : super(key: key);

  @override
  _SportsRoomBookedBState createState() => _SportsRoomBookedBState();
}

class _SportsRoomBookedBState extends State<SportsRoomBookedB> {
  var _delGroup;
