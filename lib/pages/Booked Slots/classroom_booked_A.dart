...
class ClassroomBookedA extends StatefulWidget {
  const ClassroomBookedA({Key? key}) : super(key: key);

  @override
  _ClassroomBookedAState createState() => _ClassroomBookedAState();
}

class _ClassroomBookedAState extends State<ClassroomBookedA> {
  var _delGroup;
