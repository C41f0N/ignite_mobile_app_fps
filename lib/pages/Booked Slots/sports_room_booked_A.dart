...
class SportsRoomBookedA extends StatefulWidget {
  const SportsRoomBookedA({Key? key}) : super(key: key);

  @override
  _SportsRoomBookedAState createState() => _SportsRoomBookedAState();
}

class _SportsRoomBookedAState extends State<SportsRoomBookedA> {
  var _delGroup;
