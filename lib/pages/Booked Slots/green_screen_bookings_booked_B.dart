...
class GreenScreenBookingsBookedB extends StatefulWidget {
  const GreenScreenBookingsBookedB({Key? key}) : super(key: key);

  @override
  _GreenScreenBookingsBookedBState createState() => _GreenScreenBookingsBookedBState();
}

class _GreenScreenBookingsBookedBState extends State<GreenScreenBookingsBookedB> {
  var _delGroup;
