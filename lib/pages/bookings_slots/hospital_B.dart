...
class HospitalB extends StatefulWidget {
  const HospitalB({Key? key}) : super(key: key);

  @override
  _HospitalBState createState() => _HospitalBState();
}

class _HospitalBState extends State<HospitalB> {
  var _delGroup;
