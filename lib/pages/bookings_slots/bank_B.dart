...
class BankB extends StatefulWidget {
  const BankB({Key? key}) : super(key: key);

  @override
  _BankBState createState() => _BankBState();
}

class _BankBState extends State<BankB> {
  var _delGroup;
                                ...
                                actions: [
                                  TextButton(
                                    onPressed: () async {
                                      ...
                                      bool valid  = await buyTVCSlot("Bank", "bank", doc['slot_duration'], doc['cost']);
                                      if (valid) {
