...
class NewsRoomAndComputerLabB extends StatefulWidget {
  const NewsRoomAndComputerLabB({Key? key}) : super(key: key);

  @override
  _NewsRoomAndComputerLabBState createState() => _NewsRoomAndComputerLabBState();
}

class _NewsRoomAndComputerLabBState extends State<NewsRoomAndComputerLabB> {
  var _delGroup;
