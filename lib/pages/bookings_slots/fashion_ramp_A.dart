...
class FashionRampA extends StatefulWidget {
  const FashionRampA({Key? key}) : super(key: key);

  @override
  _FashionRampAState createState() => _FashionRampAState();
}

class _FashionRampAState extends State<FashionRampA> {
  var _delGroup;
