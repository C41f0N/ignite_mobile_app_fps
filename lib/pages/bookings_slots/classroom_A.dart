...
class ClassroomA extends StatefulWidget {
  const ClassroomA({Key? key}) : super(key: key);

  @override
  _ClassroomAState createState() => _ClassroomAState();
}

class _ClassroomAState extends State<ClassroomA> {
  var _delGroup;
