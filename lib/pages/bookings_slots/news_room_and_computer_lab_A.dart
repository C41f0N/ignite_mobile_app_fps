...
class NewsRoomAndComputerLabA extends StatefulWidget {
  const NewsRoomAndComputerLabA({Key? key}) : super(key: key);

  @override
  _NewsRoomAndComputerLabAState createState() => _NewsRoomAndComputerLabAState();
}

class _NewsRoomAndComputerLabAState extends State<NewsRoomAndComputerLabA> {
  var _delGroup;
                                ...
                                actions: [
                                  TextButton(
                                    onPressed: () async {
                                      ...
                                      bool valid  = await buyTVCSlot("News/Computer Room", "news_room_and_computer_lab", doc['slot_duration'], doc['cost']);
                                      if (valid) {
