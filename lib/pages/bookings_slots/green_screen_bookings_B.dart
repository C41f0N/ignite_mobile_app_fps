...
class GreenScreenBookingsB extends StatefulWidget {
  const GreenScreenBookingsB({Key? key}) : super(key: key);

  @override
  _GreenScreenBookingsBState createState() => _GreenScreenBookingsBState();
}

class _GreenScreenBookingsBState extends State<GreenScreenBookingsB> {
  var _delGroup;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Green Screen Room",
          style: TextStyle(
                                ...
                                actions: [
                                  TextButton(
                                    onPressed: () async {
                                      ...
                                      bool valid  = await buyTVCSlot("Green Screen Room", "green_screen_room", doc['slot_duration'], doc['cost']);
                                      if (valid) {
