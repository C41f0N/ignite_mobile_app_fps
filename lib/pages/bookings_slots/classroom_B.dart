...
class ClassroomB extends StatefulWidget {
  const ClassroomB({Key? key}) : super(key: key);

  @override
  _ClassroomBState createState() => _ClassroomBState();
}

class _ClassroomBState extends State<ClassroomB> {
  var _delGroup;
                                ...
                                actions: [
                                  TextButton(
                                    onPressed: () async {
                                      ...
                                      bool valid  = await buyTVCSlot("Classroom", "classroom", doc['slot_duration'], doc['cost']);
                                      if (valid) {
