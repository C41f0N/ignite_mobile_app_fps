...
class SportsRoomB extends StatefulWidget {
  const SportsRoomB({Key? key}) : super(key: key);

  @override
  _SportsRoomBState createState() => _SportsRoomBState();
}

class _SportsRoomBState extends State<SportsRoomB> {
  var _delGroup;
                                ...
                                actions: [
                                  TextButton(
                                    onPressed: () async {
                                      ...
                                      bool valid  = await buyTVCSlot("Sports Room", "sports_room", doc['slot_duration'], doc['cost']);
                                      if (valid) {
