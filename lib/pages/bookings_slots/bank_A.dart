...
class BankA extends StatefulWidget {
  const BankA({Key? key}) : super(key: key);

  @override
  _BankAState createState() => _BankAState();
}

class _BankAState extends State<BankA> {
  var _delGroup;
                                ...
                                actions: [
                                  TextButton(
                                    onPressed: () async {
                                      ...
                                      bool valid  = await buyTVCSlot("Bank Set", "bank", doc['slot_duration'], doc['cost']);
                                      if (valid) {
