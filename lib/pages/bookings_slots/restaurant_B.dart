...
class RestaurantB extends StatefulWidget {
  const RestaurantB({Key? key}) : super(key: key);

  @override
  _RestaurantBState createState() => _RestaurantBState();
}

class _RestaurantBState extends State<RestaurantB> {
  var _delGroup;
                                ...
                                actions: [
                                  TextButton(
                                    onPressed: () async {
                                      ...
                                      bool valid  = await buyTVCSlot("Restaurant", "restaurant", doc['slot_duration'], doc['cost']);
                                      if (valid) {
