...
class RestaurantA extends StatefulWidget {
  const RestaurantA({Key? key}) : super(key: key);

  @override
  _RestaurantAState createState() => _RestaurantAState();
}

class _RestaurantAState extends State<RestaurantA> {
  var _delGroup;
