...
class GreenScreenBookingsA extends StatefulWidget {
  const GreenScreenBookingsA({Key? key}) : super(key: key);

  @override
  _GreenScreenBookingsAState createState() => _GreenScreenBookingsAState();
}

class _GreenScreenBookingsAState extends State<GreenScreenBookingsA> {
  var _delGroup;
