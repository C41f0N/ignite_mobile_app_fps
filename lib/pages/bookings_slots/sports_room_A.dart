...
class SportsRoomA extends StatefulWidget {
  const SportsRoomA({Key? key}) : super(key: key);

  @override
  _SportsRoomAState createState() => _SportsRoomAState();
}

class _SportsRoomAState extends State<SportsRoomA> {
  var _delGroup;
