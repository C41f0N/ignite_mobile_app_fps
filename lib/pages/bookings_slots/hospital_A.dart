...
class HospitalA extends StatefulWidget {
  const HospitalA({Key? key}) : super(key: key);

  @override
  _HospitalAState createState() => _HospitalAState();
}

class _HospitalAState extends State<HospitalA> {
  var _delGroup;
                                ...
                                actions: [
                                  TextButton(
                                    onPressed: () async {
                                      ...
                                      bool valid  = await buyTVCSlot("Hospital", "hospital", doc['slot_duration'], doc['cost']);
                                      if (valid) {
