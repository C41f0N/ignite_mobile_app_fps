...
class ScienceLabB extends StatefulWidget {
  const ScienceLabB({Key? key}) : super(key: key);

  @override
  _ScienceLabBState createState() => _ScienceLabBState();
}

class _ScienceLabBState extends State<ScienceLabB> {
  var _delGroup;
