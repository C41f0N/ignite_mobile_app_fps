...
class FashionRampB extends StatefulWidget {
  const FashionRampB({Key? key}) : super(key: key);

  @override
  _FashionRampBState createState() => _FashionRampBState();
}

class _FashionRampBState extends State<FashionRampB> {
  var _delGroup;
                                ...
                                actions: [
                                  TextButton(
                                    onPressed: () async {
                                      ...
                                      bool valid  = await buyTVCSlot("Fashion Ramp", "fashion_ramp", doc['slot_duration'], doc['cost']);
                                      if (valid) {
